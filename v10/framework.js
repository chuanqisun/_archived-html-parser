export class Component {
    ...
    _renderArgumentPlaceholdersRecursive(context) {
        if (context.arg instanceof Array) {
            ...
            const placeholderNote = context.tempRoot.getElementsByClassName(`placeholder-${context.currentPlaceholderIndex++}`)[0];
            placeholderNote.parentNode.replaceChild(context.arg._asElement(), placeholderNote);
        }
    }
}